...
import static com.fs.starfarer.api.impl.campaign.ids.FleetTypes.SCAVENGER_SMALL;
...
public class BlueMoonPlugin extends BaseModPlugin {
	...
	public void onNewGame() {
		...
		MarketAPI seduveren_market = Global.getFactory().createMarket("seduveren_market", Bluemoon_Seduveren_planet.getName(), 4);
